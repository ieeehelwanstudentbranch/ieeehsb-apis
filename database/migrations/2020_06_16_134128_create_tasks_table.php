...
class CreateTasksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->string('file_sent',2000)->nullable();
            $table->string('body_delivered',3000)->nullable();
            $table->string('file_delivered',3000)->nullable();
            $table->string('evaluation',3000)->nullable();
