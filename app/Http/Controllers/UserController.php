...
class UserController extends Controller
{
    ...
    public function updateProfile(Request $request , $id){
        ...
        if ($request->input('phone')){ $user->DOB= $request->input('phone');}
        if ($request->input('level')){ $user->DOB= $request->input('level');}
        if ($request->input('address')){ $user->DOB= $request->input('address');}
